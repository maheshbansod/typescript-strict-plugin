...
const getProjectPathFromArgsMock = jest_mock_1.mocked(utils_1.getProjectPathFromArgs);
const getAbsolutePathMock = jest_mock_1.mocked(getAbsolutePath_1.getAbsolutePath);
...
describe('isFileOnPath', () => {
    ...
    it('when getProjectPathFromArgs is defined, use defined value', () => {
        //when
        isFileOnPath_1.isFileOnPath({ filePath: '/some_file_path/lib_dir/file.ts', targetPath: './lib_dir' });
        // then
        expect(getAbsolutePathMock).toHaveBeenCalledTimes(1);
